...
var spec = commandSchema{
	...
	Commands: []commandEntry{
		...
		{Name: "task today", Short: "Plan today's tasks within a time budget", OutputKind: "task_today_result"},
		{Name: "task schedule", Short: "Periodically snapshot your tasks via a self-contained daemon"},
		{Name: "task schedule add", Short: "Register the current repository with the snapshot daemon", OutputKind: "schedule_add_result"},
		{Name: "task schedule list", Short: "List watched repositories and the daemon status", OutputKind: "schedule_list_result"},
		{Name: "task schedule remove", Short: "Unregister the current repository from the snapshot daemon", OutputKind: "schedule_remove_result"},
		{Name: "task schedule start", Short: "Start the snapshot daemon", OutputKind: "schedule_start_result"},
		{Name: "task schedule stop", Short: "Stop the snapshot daemon (SIGTERM)", OutputKind: "schedule_stop_result"},
		{Name: "task schedule status", Short: "Show the daemon pid and per-repo run counts", OutputKind: "schedule_status_result"},
